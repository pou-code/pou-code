...
Sekarang gw masih pelajar kelas 2 SMA di salah satu sekolah Islam di Bandung.

Di sekolah gw sebenarnya gak ada pelajaran yang ngebahas pemrograman secara mendalam. Jadi hampir semua yang gw pelajari tentang JavaScript, Node.js, WhatsApp Web, sampai bikin library, gw pelajari sendiri dari dokumentasi, source code open source, trial & error, dan rasa penasaran.

Awalnya cuma iseng pengen tahu gimana WhatsApp Web bekerja di balik layar. Lama-lama malah keterusan ngulik protocol, baca source code project open source, bikin eksperimen sendiri, sampai akhirnya mulai bikin library dan bot yang sekarang gw pakai sehari-hari.

Kerjaan gw sehari-hari ya kurang lebih buka VS Code, nulis kode, `console.log()` sesuatu, bingung kenapa gak jalan, terus beberapa menit kemudian baru sadar ternyata kurang satu koma.

Gw bukan orang yang paling jago ngoding. Masih banyak banget yang harus dipelajari. Tapi gw percaya kalau konsisten belajar sedikit demi sedikit, hasilnya bakal kelihatan.

Kalau kode gw jalan, itu alhamdulillah.

Kalau gak jalan...

Berarti waktunya ngopi.
...
Cocok buat yang baru mulai belajar bikin bot tanpa harus langsung berhadapan sama struktur project yang besar.
